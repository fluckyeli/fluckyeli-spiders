...
def get_html_content_type_4(unit_id='1305713611', content_id='1263014'):
    # 使用账号密码登录
    ...
    contentType = 4  # 富文本类型
    data = (f"callCount=1\n"
            f"scriptSessionId={scriptSessionId}190\n"
...
if __name__ == '__main__':
    unit_id = '1305713604'
    content_id = '1240486386'
    res = get_html_content_type_4(unit_id, content_id)
